  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .banner-breaking {
      ...
      color: var(--accent-amber); text-shadow: 0 0 12px rgba(255,176,32,.6);
    }
    ...
    .bt-hl { color: var(--accent-gold); font-weight: 500; }
    .bt-dim { color: rgba(196,216,224,.38); }
    .bt-dot { width: 4px; height: 4px; border-radius: 50%; background: var(--accent-amber); opacity: 0.5; flex-shrink: 0; }
    ...
    .banner-close:hover { color: var(--accent-amber); background: rgba(255,176,32,.06); }
    ...
    #spb {
      ...
      z-index: 99999; box-shadow: 0 0 12px var(--accent-green);
    ...
    .sec-sub { max-width: 660px; color: var(--text-secondary); font-size: 15px; }
    .sec-title em {
      background: linear-gradient(90deg,var(--accent-green),#a0ffe0,var(--accent-green));
    ...
    .ld-logo { font-family:var(--F1); font-size: clamp(72px,20vw,160px); font-weight:700; color: var(--accent-green); line-height:1; letter-spacing:.06em; text-shadow: 0 0 60px rgba(0,255,110,.9), 0 0 180px rgba(0,255,110,.3); }
    ...
    .ld-fill { width:0%;height:100%;background:linear-gradient(90deg,var(--accent-green),var(--accent-cyan));box-shadow:0 0 10px var(--accent-green);transition:width .18s ease; }
    ...
    .nav-mark { width:34px; height:34px; border-radius:50%; display:flex; align-items:center; justify-content:center; background: rgba(0,255,110,.08); border:1px solid rgba(0,255,110,.2); font-family:var(--F1); font-size:12px; font-weight:700; color:var(--accent-green); text-shadow: 0 0 12px var(--accent-green); overflow:hidden; }
    ...
    .nav-links a::after { content:''; position:absolute; bottom:-2px;left:0; width:0; height:1px; background:var(--accent-green); box-shadow:0 0 6px var(--accent-green); transition:width .3s ease; }
    .nav-links a:hover { color:var(--text-primary); }
    .nav-links a:hover::after { width:100%; }
    .nav-cta { padding:8px 20px; border-radius:999px; background:rgba(0,255,110,.08); border:1px solid rgba(0,255,110,.25); font-family:var(--F1); font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:var(--accent-green); transition: background .25s, box-shadow .25s; }
    ...
    .hamburger span { height:1.5px; background:var(--text-primary); border-radius:1px; transition:all .3s ease; }
    ...
    .mnav a:hover { color:var(--accent-green); }
    ...
    .hero-pill-dot { width:8px;height:8px;border-radius:50%; background:var(--accent-green);box-shadow:0 0 10px var(--accent-green); animation: pulse 2s ease-in-out infinite; }
    ...
    .hero-title .hi { display:block; background:linear-gradient(90deg,var(--accent-green),#a0ffe0 35%,var(--accent-cyan) 65%,#50ffaa); background-size:200% auto; -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; animation:shimmer 3s linear infinite; }
    ...
    .hero-desc strong { color:var(--accent-green); font-weight:500; }
    .hero-actions { display:flex; gap:14px; flex-wrap:wrap; margin-bottom:36px; }
    .btn-p { padding:13px 28px; border-radius:999px; background:var(--accent-green); color:var(--bg-void); font-family:var(--F1); font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:.08em; transition:transform .2s, box-shadow .2s; box-shadow: 0 0 24px rgba(0,255,110,.25); }
    .btn-p:hover { transform:translateY(-2px); box-shadow:0 8px 32px rgba(0,255,110,.4); }
    .btn-s { padding:13px 28px; border-radius:999px; border:1px solid rgba(0,255,110,.3); color:var(--accent-green); font-family:var(--F1); font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:.08em; transition:all .2s; }
    ...
    .hstat-n { font-family:var(--F1); font-size:26px; font-weight:700; color:var(--accent-green); line-height:1; }
    ...
    .tcursor { display:inline-block; width:7px;height:13px; background:var(--accent-green); animation:blink 1s step-end infinite; vertical-align:middle; }
    ...
    .soc-live-badge { display:flex; align-items:center; gap:7px; padding:4px 11px; border-radius:999px; background:rgba(0,255,110,.06); border:1px solid rgba(0,255,110,.18); font-family:var(--FM); font-size:9px; letter-spacing:.14em; text-transform:uppercase; color:var(--accent-green); }
    .soc-live-dot { width:6px;height:6px;border-radius:50%; background:var(--accent-green); box-shadow:0 0 8px var(--accent-green); animation:pulse 2s ease-in-out infinite; }
    ...
    .sev-c { background:var(--accent-red);box-shadow:0 0 6px var(--accent-red); } .sev-h { background:var(--accent-amber);box-shadow:0 0 6px var(--accent-amber); } .sev-m { background:var(--accent-cyan);box-shadow:0 0 6px var(--accent-cyan); } .sev-l { background:rgba(196,216,224,.3); }
    .alert-name { font-family:var(--FM); font-size:10px; color:var(--text-primary); flex:1; }
    ...
    .winner-badge { position: absolute; top: 10px; right: 10px; z-index: 10; display: flex; align-items: center; gap: 6px; padding: 5px 10px; border-radius: 999px; background: rgba(255,208,96,.12); border: 1px solid rgba(255,208,96,.35); font-family: var(--FM); font-size: 8px; letter-spacing: .14em; text-transform: uppercase; color: var(--accent-gold); backdrop-filter: blur(12px); box-shadow: 0 0 16px rgba(255,208,96,.15); }
    .winner-trophy { font-size: 11px; animation: trophyPulse 2.5s ease-in-out infinite; }
    .innov-tag { display: inline-flex; align-items: center; gap: 7px; padding: 4px 10px; border-radius: 6px; margin-bottom: 10px; font-family: var(--FM); font-size: 8px; letter-spacing: .14em; text-transform: uppercase; background: rgba(255,208,96,.07); border: 1px solid rgba(255,208,96,.2); color: var(--accent-gold); }
    .innov-tag-dot { width: 5px; height: 5px; border-radius: 50%; background: var(--accent-gold); box-shadow: 0 0 6px var(--accent-gold); }
    ...
    .pc-live .proj-accent { background:linear-gradient(90deg,var(--accent-green),transparent 80%); }
    .pc-wip .proj-accent { background:linear-gradient(90deg,var(--accent-amber),transparent 80%); }
    .pc-winner .proj-accent { background:linear-gradient(90deg,var(--accent-gold),var(--accent-amber) 40%,transparent 80%); }
    .pc-purple .proj-accent { background:linear-gradient(90deg,var(--accent-purple),transparent 80%); }
    ...
    .ps-live { background:rgba(0,255,110,.07); border:1px solid rgba(0,255,110,.2); color:var(--accent-green); }
    .ps-live .ps-dot { background:var(--accent-green); box-shadow:0 0 5px var(--accent-green); animation:pulse 2s ease-in-out infinite; }
    .ps-wip { background:rgba(255,176,32,.07); border:1px solid rgba(255,176,32,.2); color:var(--accent-amber); }
    .ps-wip .ps-dot { background:var(--accent-amber); }
    .ps-concluded { background:rgba(255,208,96,.07); border:1px solid rgba(255,208,96,.25); color:var(--accent-gold); }
    .ps-concluded .ps-dot { background:var(--accent-gold); box-shadow:0 0 5px var(--accent-gold); }
    .ps-purple { background:rgba(155,111,255,.07); border:1px solid rgba(155,111,255,.2); color:var(--accent-purple); }
    .ps-purple .ps-dot { background:var(--accent-purple); box-shadow:0 0 5px var(--accent-purple); animation:pulse 2s ease-in-out infinite; }
    ...
    .proj-link { display:inline-flex; align-items:center; gap:7px; font-family:var(--FM); font-size:10px; letter-spacing:.12em; text-transform:uppercase; color:var(--accent-green); transition:gap .2s; }
    .pc-wip .proj-link { color:var(--accent-amber); } .pc-winner .proj-link { color:var(--accent-gold); } .pc-purple .proj-link { color:var(--accent-purple); }
    .proj-link:hover { gap:14px; }
    .proj-link.secondary { color: rgba(0,212,255,.7); font-size: 9px; }
    .proj-link.secondary:hover { gap: 10px; color: var(--accent-cyan); }
    ...
    .sk-tab:hover { color:var(--text-primary); border-color:rgba(0,255,110,.2); }
    .sk-tab.active { color:var(--accent-green); background:rgba(0,255,110,.08); border-color:rgba(0,255,110,.25); box-shadow:0 0 16px rgba(0,255,110,.08); }
    ...
    .id-val.highlight { color:var(--accent-green); }
    ...
    .about-p strong { color:var(--accent-green); font-weight:500; }
    ...
    .tl-dot-g { background:var(--accent-green);box-shadow:0 0 12px var(--accent-green); } .tl-dot-c { background:var(--accent-cyan);box-shadow:0 0 12px var(--accent-cyan); }
    ...
    .tl-active.green { color:var(--accent-green);background:rgba(0,255,110,.07);border:1px solid rgba(0,255,110,.18); }
    .tl-active.cyan { color:var(--accent-cyan);background:rgba(0,212,255,.07);border:1px solid rgba(0,212,255,.18); }
    ...
    .cl-g { color:var(--accent-green);background:rgba(0,255,110,.06);border:1px solid rgba(0,255,110,.15); }
    .cl-g:hover { background:rgba(0,255,110,.12);box-shadow:0 0 10px rgba(0,255,110,.15); }
    .cl-c { color:var(--accent-cyan);background:rgba(0,212,255,.06);border:1px solid rgba(0,212,255,.15); }
    .cl-c:hover { background:rgba(0,212,255,.12); }
    .cl-a { color:var(--accent-amber);background:rgba(255,176,32,.06);border:1px solid rgba(255,176,32,.15); }
    .cl-a:hover { background:rgba(255,176,32,.12); }
    .cl-p { color:var(--accent-purple);background:rgba(155,111,255,.06);border:1px solid rgba(155,111,255,.15); }
    ...
    .ct-issuer { color: var(--text-primary); font-weight: 600; }
    .ct-status { color: var(--accent-green); letter-spacing: 0.1em; }
    ...
    .ct-desc { font-size: 11px; color: rgba(196, 216, 224, 0.65); line-height: 1.45; font-family: var(--F1); }
    .ct-verify-btn {
      width: 100%;
      padding: 7px 12px;
      border-radius: 6px;
    ...
    .ct-verify-btn.btn-g { color: var(--accent-green); background: rgba(0, 255, 110, 0.08); border: 1px solid rgba(0, 255, 110, 0.2); }
    .ct-verify-btn.btn-g:hover { background: rgba(0, 255, 110, 0.16); box-shadow: 0 0 12px rgba(0, 255, 110, 0.3); }
    .ct-verify-btn.btn-c { color: var(--accent-cyan); background: rgba(0, 212, 255, 0.08); border: 1px solid rgba(0, 212, 255, 0.2); }
    .ct-verify-btn.btn-c:hover { background: rgba(0, 212, 255, 0.16); box-shadow: 0 0 12px rgba(0, 212, 255, 0.3); }
    .ct-verify-btn.btn-a { color: var(--accent-amber); background: rgba(255, 176, 32, 0.08); border: 1px solid rgba(255, 176, 32, 0.2); }
    .ct-verify-btn.btn-a:hover { background: rgba(255, 176, 32, 0.16); box-shadow: 0 0 12px rgba(255, 176, 32, 0.3); }
    .ct-verify-btn.btn-p { color: var(--accent-purple); background: rgba(155, 111, 255, 0.08); border: 1px solid rgba(155, 111, 255, 0.2); }
    ...
    .sg-label.cyan { border-color: rgba(0, 212, 255, 0.3); color: var(--accent-cyan); }
    .sg-label.cyan:hover { background: rgba(0, 212, 255, 0.15); border-color: var(--accent-cyan); box-shadow: 0 0 15px rgba(0, 212, 255, 0.45); }
    .sg-label.amber { border-color: rgba(255, 176, 32, 0.3); color: var(--accent-amber); }
    .sg-label.amber:hover { background: rgba(255, 176, 32, 0.15); border-color: var(--accent-amber); box-shadow: 0 0 15px rgba(255, 176, 32, 0.45); }
    .sg-label.purple { border-color: rgba(155, 111, 255, 0.3); color: var(--accent-purple); }
    .sg-label.purple:hover { background: rgba(155, 111, 255, 0.15); border-color: var(--accent-purple); box-shadow: 0 0 15px rgba(155, 111, 255, 0.45); }
    .sg-label.red { border-color: rgba(255, 45, 85, 0.3); color: var(--accent-red); }
    .sg-label.red:hover { background: rgba(255, 45, 85, 0.15); border-color: var(--accent-red); box-shadow: 0 0 15px rgba(255, 45, 85, 0.45); }
    ...
    .iterm-prompt { font-family:var(--FM);font-size:12px;color:var(--accent-green);white-space:nowrap; }
    .iterm-input { flex:1;background:none;border:none;outline:none;font-family:var(--FM);font-size:12px;color:var(--text-primary);caret-color:var(--accent-green); }
    ...
    .icmd:hover { background:rgba(0,255,110,.1);color:var(--accent-green); }
    ...
    .cf-input, .cf-area { background:rgba(0,0,0,.3); border:1px solid rgba(0,255,110,.1); border-radius:8px; padding:11px 14px; font-family:var(--FM); font-size:12px; color:var(--text-primary); outline:none; transition:border-color .2s, box-shadow .2s; }
    ...
    .cf-submit { width:100%; padding:13px; background:rgba(0,255,110,.1); border:1px solid rgba(0,255,110,.25); border-radius:10px; color:var(--accent-green); font-family:var(--F1); font-size:11px; font-weight:700; letter-spacing:.1em; text-transform:uppercase; transition:all .25s; margin-top:4px; }
    ...
    .cf-status.ok { color:var(--accent-green); } .cf-status.err { color:var(--accent-red); }
    ...
    .footer-brand { font-family:var(--F1);font-size:20px;font-weight:700;color:var(--accent-green);text-shadow:0 0 20px var(--accent-green); }
    ...
    .footer-status-dot { width:6px;height:6px;border-radius:50%;background:var(--accent-green);box-shadow:0 0 8px var(--accent-green);animation:pulse 2s ease-in-out infinite; }
    ...
    .acad-grade.green { color: var(--accent-green); }
    .acad-grade.amber { color: var(--accent-amber); }
    .acad-track {
      width: 100%;
      height: 6px;
    ...
    .acad-fill.green {
      background: linear-gradient(90deg, var(--accent-green), #67ffad);
      box-shadow: 0 0 8px rgba(103, 255, 173, 0.3);
    }
    .acad-fill.amber {
      background: linear-gradient(90deg, var(--accent-amber), #ffe07d);
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div class="about-avatar-container glass rv d2" style="display:flex;align-items:center;gap:20px;padding:20px;border-radius:20px;position:relative;overflow:hidden;">
          ...
          <div style="display:flex;flex-direction:column;gap:4px;">
            ...
            <div style="font-family:var(--FM);font-size:10px;color:var(--accent-green);">ID: PL-001 // SEC_OP</div>
          </div>
          <!-- Scanline indicator -->
        ...
        <div class="about-id glass rv d2" style="margin-bottom:0;">
          ...
          <div class="id-field">
            ...
            <div class="id-val" style="display:flex;align-items:center;gap:9px;">
              <span style="width:8px;height:8px;border-radius:50%;background:var(--accent-green);box-shadow:0 0 10px var(--accent-green);animation:pulse 2s ease-in-out infinite;flex-shrink:0;"></span>
              <span style="color:var(--accent-green);font-family:var(--FM);font-size:12px;letter-spacing:.1em;text-transform:uppercase;">Open to Opportunities</span>
            </div>
          </div>
          <div class="id-field" style="margin-bottom:0"><div class="id-key">Clearance Level</div><div class="id-val" style="color:var(--accent-green);">Highly Competent</div></div>
        </div>
...
<section id="experience" class="section">
  <div class="container">
    ...
    <h2 class="sec-title rv d1" style="--em-c:var(--accent-cyan);">Field<br/><em style="-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--accent-cyan),#a0f8ff,var(--accent-cyan));background-size:200% auto;-webkit-background-clip:text;background-clip:text;animation:shimmer 4s linear infinite;">Operations</em></h2>
    ...
    <div class="timeline rv d3">
      <div class="tl-item">
        ...
        <div class="tl-card glass">
          <div class="tl-active green"><span class="tl-active-dot" style="background:var(--accent-green);"></span>Active Operations</div>
          <div class="tl-head">
      ...
      <div class="tl-item">
        ...
        <div class="tl-card glass">
          <div class="tl-active cyan"><span class="tl-active-dot" style="background:var(--accent-cyan);"></span>Active Deployment</div>
          <div class="tl-head">
...
<section id="endorsements" class="section">
  <div class="container">
    ...
    <h2 class="sec-title rv d1" style="--em-c:var(--accent-green);">Academic<br/><em style="-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--accent-green),#67ffad,var(--accent-green));background-size:200% auto;-webkit-background-clip:text;background-clip:text;animation:shimmer 4s linear infinite;">Endorsements</em></h2>
    ...
    <div style="display:flex; flex-direction:column; gap:30px; margin-top:44px;">
      ...
      <div class="endorsement-card glass rv d3" style="margin-top:0;">
        ...
        <div class="end-footer" style="margin-bottom: 20px;">
          ...
          <div class="end-badge-stamp">
            <svg class="end-seal" viewBox="0 0 100 100">
              ...
              <text x="50" y="52" text-anchor="middle" font-size="8" fill="var(--accent-green)" font-family="var(--FM)" font-weight="bold" letter-spacing="1">FACULTY</text>
        ...
        <div style="border-top: 1px solid rgba(255,255,255,.05); padding-top: 20px; display: flex;">
          <a href="assets/Prem_Kantilal_Lodhia_RL_1.pdf" target="_blank" class="ct-verify-btn btn-g" style="display: inline-flex; align-items: center; gap: 7px; padding: 10px 22px; border-radius: 8px; font-family: var(--FM); font-size: 10px; font-weight: 700; text-transform: uppercase; color: var(--accent-green); background: rgba(0, 255, 110, 0.08); border: 1px solid rgba(0, 255, 110, 0.25); transition: all 0.25s;">
      ...
      <div class="endorsement-card glass rv d4" style="margin-top:0; border-color: rgba(0, 212, 255, 0.15);">
        <div class="end-security-header">
          <div class="end-security-status" style="color: var(--accent-cyan);">
        ...
        <div class="end-footer">
          <div class="end-signatory">
            ...
            <div class="end-sig-title" style="color: var(--accent-cyan);">Associate Professor in AI &middot; Turing Fellow</div>
          ...
          <div class="end-badge-stamp">
            <svg class="end-seal" viewBox="0 0 100 100">
              ...
              <text x="50" y="52" text-anchor="middle" font-size="8" fill="var(--accent-cyan)" font-family="var(--FM)" font-weight="bold" letter-spacing="1">TURING</text>
...
<section id="skills" class="section">
  <div class="container">
    ...
    <h2 class="sec-title rv d1"><em style="-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--accent-cyan),#a0f8ff,var(--accent-cyan));background-size:200% auto;-webkit-background-clip:text;background-clip:text;animation:shimmer 4s linear infinite;">Network</em><br/>Activity</h2>
    ...
    <div class="prof-grid rv d4">
      <div class="prof-card glass">
        ...
        <div class="prof-bar"><div class="prof-bh"><span>Security</span><span style="color:var(--accent-green)">68%</span></div><div class="prof-track"><div class="prof-fill" data-w="68" style="background:linear-gradient(90deg,var(--accent-green),#67ffad)"></div></div></div>
        <div class="prof-bar"><div class="prof-bh"><span>Cloud</span><span style="color:var(--accent-cyan)">64%</span></div><div class="prof-track"><div class="prof-fill" data-w="64" style="background:linear-gradient(90deg,var(--accent-cyan),#7ee7ff)"></div></div></div>
        <div class="prof-bar"><div class="prof-bh"><span>Development</span><span style="color:var(--accent-purple)">68%</span></div><div class="prof-track"><div class="prof-fill" data-w="68" style="background:linear-gradient(90deg,var(--accent-purple),#c2b5ff)"></div></div></div>
        <div class="prof-bar"><div class="prof-bh"><span>AI / ML</span><span style="color:var(--accent-amber)">65%</span></div><div class="prof-track"><div class="prof-fill" data-w="65" style="background:linear-gradient(90deg,var(--accent-amber),#ffd27a)"></div></div></div>
      ...
      <div class="prof-card glass">
        ...
        <div class="prof-bar"><div class="prof-bh"><span>Cloud Security</span><span style="color:var(--accent-green)">90%</span></div><div class="prof-track"><div class="prof-fill" data-w="90" style="background:linear-gradient(90deg,var(--accent-green),#67ffad)"></div></div></div>
        <div class="prof-bar"><div class="prof-bh"><span>AWS &amp; Cloud Infrastructure</span><span style="color:var(--accent-cyan)">86%</span></div><div class="prof-track"><div class="prof-fill" data-w="86" style="background:linear-gradient(90deg,var(--accent-cyan),#7ee7ff)"></div></div></div>
        ...
        <div class="prof-bar"><div class="prof-bh"><span>AI Security Workflows</span><span style="color:var(--accent-amber)">82%</span></div><div class="prof-track"><div class="prof-fill" data-w="82" style="background:linear-gradient(90deg,var(--accent-amber),#ffd27a)"></div></div></div>
        <div class="prof-bar" style="margin-bottom:0"><div class="prof-bh"><span>Python Automation</span><span style="color:var(--accent-purple)">80%</span></div><div class="prof-track"><div class="prof-fill" data-w="80" style="background:linear-gradient(90deg,var(--accent-purple),#c2b5ff)"></div></div></div>
      </div>
    </div>
      ...
      <div class="soc-grid">
        ...
        <div class="soc-cell soc-stats">
          ...
          <div class="soc-stats-row">
            <div class="soc-stat"><div class="soc-stat-n" id="stat-events" style="color:var(--accent-green)">0</div><div class="soc-stat-l">Events/min</div><div class="soc-chart-area"><canvas id="chartEvents"></canvas></div></div>
            <div class="soc-stat"><div class="soc-stat-n" id="stat-alerts" style="color:var(--accent-amber)">0</div><div class="soc-stat-l">Open Alerts</div><div class="soc-chart-area"><canvas id="chartAlerts"></canvas></div></div>
            <div class="soc-stat"><div class="soc-stat-n" id="stat-blocked" style="color:var(--accent-cyan)">0</div><div class="soc-stat-l">Blocked</div><div class="soc-chart-area"><canvas id="chartBlocked"></canvas></div></div>
            <div class="soc-stat"><div class="soc-stat-n" id="stat-fp" style="color:var(--accent-purple)">0%</div><div class="soc-stat-l">False Positive Rate</div><div class="soc-chart-area"><canvas id="chartFP"></canvas></div></div>
          </div>
        </div>
      </div>
    </div>
...
<section id="certifications" class="section">
  <div class="container">
    ...
    <h2 class="sec-title rv d1">Credential<br/><em style="-webkit-text-fill-color:transparent;background:linear-gradient(90deg,var(--accent-purple),#d8c5ff,var(--accent-purple));background-size:200% auto;-webkit-background-clip:text;background-clip:text;animation:shimmer 4s linear infinite;">Vault</em></h2>
    ...
    <div class="certs-grid">
      <div class="cert-card rv d1">
        <div class="cert-dot" style="background:var(--accent-green);box-shadow:0 0 10px var(--accent-green);"></div>
      ...
      <div class="cert-card rv d2">
        <div class="cert-dot" style="background:var(--accent-cyan);box-shadow:0 0 10px var(--accent-cyan);"></div>
      ...
      <div class="cert-card rv d3">
        <div class="cert-dot" style="background:var(--accent-amber);box-shadow:0 0 10px var(--accent-amber);"></div>
        <div class="cert-issuer">IBM</div>
      ...
      <div class="cert-card rv d6">
        <div class="cert-dot" style="background:var(--accent-purple);box-shadow:0 0 10px var(--accent-purple);"></div>
...
<section id="terminal-sec">
  <div class="container">
    ...
    <p class="sec-sub rv d2">Type a command to navigate. Try: <code style="font-family:var(--FM);font-size:12px;color:var(--accent-green);">help</code> to see all available commands.</p>
...
<div class="ask-prem-widget" id="askPremWidget">
  ...
  <div class="ask-prem-window" id="askPremWindow">
    ...
    <div class="chat-settings-panel" id="chatSettingsPanel">
      ...
      <div class="settings-sec-note" style="font-size: 9px; color: var(--accent-cyan); margin-bottom: 8px; line-height: 1.3; background: rgba(0, 212, 255, 0.05); padding: 6px 10px; border-radius: 4px; border: 1px solid rgba(0, 212, 255, 0.15)">
...
function revealAboveFold() {
  const revealNow = () => {
    document.querySelectorAll(".observe-me").forEach(el => {
      ...
      if(r.top < window.innerHeight + 80) el.classList.add("animate-in");
    });
  };
...
<span class="io-c">  Redirecting to blog.html portal...</span>`;
  ...
  function execCmd(raw) {
    ...
    cmdLine.innerHTML = `<span class="io-line"><span style="color:var(--accent-green)">prem@sec:~$</span> <span style="color:var(--text-primary)">${raw}</span></span>`;
...
function setupVisitorGeo() {
  ...
  function injectGeoAlert(data) {
    ...
    item.innerHTML = `
      <div class="alert-top">
        <div class="alert-sev sev-m" style="background:var(--accent-cyan); box-shadow:0 0 8px var(--accent-cyan);"></div>
...
function setup3dSkillGraph() {
  ...
  centerLabel.addEventListener("click", () => {
    playClickSound();
    triggerParticleBurstForEl(centerLabel, "var(--accent-green)");
...
(function() {
  ...
  if (heroLeft && heroRight) {
    document.addEventListener('mousemove', (e) => {
      ...
      heroLeft.style.transform = 'translate(' + x + 'px, ' + y + 'px)';
      heroRight.style.transform = 'translate(' + (-x * 0.5) + 'px, ' + (-y * 0.5) + 'px)';
    });
  }
})();
